...
class ChatActivity : AppCompatActivity() {
    ...
    // API key loaded from BuildConfig (set GROQ_API_KEY in local.properties)
    // To configure: add GROQ_API_KEY=your_key_here to local.properties
    // Then add to app/build.gradle.kts: buildConfigField("String", "GROQ_API_KEY", "\"${project.findProperty("GROQ_API_KEY") ?: ""}\"")
    private val apiKey = try { BuildConfig.GROQ_API_KEY } catch (e: Exception) { "" }
